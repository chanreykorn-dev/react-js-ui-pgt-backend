...
const headCells = [
    ...
    { id: "descriptions", label: "Description", width: 300 },
    ...
    return (
        <Box sx={{ width: "100%" }}>
            <ToastContainer
                ...
                transition={Bounce}
            />
            <ActiveLastBreadcrumb label={"Warranty"} endpoint={"List Warranty"} />
            <Paper sx={{ width: "100%", mb: 2 }}>

                <Box sx={{ padding: "5px 16px" }}>
                    <Header title="Warranty" subtitle="List of all Warranty" />
                </Box>

                <Box sx={{ padding: "5px 16px" }}>
                    <Link to="/warranty/add" style={{ textDecoration: "none" }}>
                        <Button variant="contained">Create Warranty</Button>
                    </Link>
                </Box>
                        ...
                        <TableBody>
                            {visibleRows.map((row) => (
                                <TableRow hover key={row.id}>
                                    <TableCell>
                                        <ActionEdit
                                            onEdit={() => navigate(`/warranty/edit/${row.id}`)}
                                            message="Edit Warranty"
                                        />
                                        <ActionDelete
                                            link={`${import.meta.env.VITE_API_URL}/warranty/delete/${row.id}`}
                                            onDelete={fetchWarranty}
