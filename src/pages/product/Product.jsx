...
import AlertDialogSlide from "../../components/Options";


const headCells = [
    { id: "action", label: "Action", width: 120 },
    { id: "option", label: "Option", width: 120 },
...
export default function Product() {
    ...
    return (
        <Box sx={{ width: "100%" }}>
            ...
            <ActiveLastBreadcrumb label={"Products"} endpoint={"List Products"} />
                                ...
                                <TableRow hover key={row.id}>
                                    <TableCell>
                                        <ActionEdit
                                            ...
                                            disabled={!hasPermission("Update Products")}
                                        />
                                        <ActionDelete
                                            link={`${import.meta.env.VITE_API_URL}/product/delete/${row.id}`}
                                    ...
                                    {!isSmall && (
                                        <TableCell>
                                            <img
                                                src={`${import.meta.env.VITE_API_URL}/uploads/${row.primary_path}`}
                                                alt={row.name}
                                                style={{
                                                    width: 100,
                                                    height: 30,
